...
public partial class AkSoundEngine {
  ...
  public static uint DynamicSequenceOpen(UnityEngine.GameObject in_gameObjectID, uint in_uFlags, AkCallbackManager.EventCallback in_pfnCallback, object in_pCookie, AK.SoundEngine.DynamicSequence.DynamicSequenceType in_eDynamicSequenceType) {
  ...
  public static AKRESULT SetMultiplePositions(UnityEngine.GameObject in_GameObjectID, AkPositionArray in_pPositions, ushort in_NumPositions, AK.SoundEngine.MultiPositionType in_eMultiPositionType) { return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetMultiplePositions__SWIG_0(AkSoundEngine.GetAkGameObjectID(in_GameObjectID), in_pPositions.m_Buffer, in_NumPositions, (int)in_eMultiPositionType); }
  ...
  public static AKRESULT SetMultiplePositions(UnityEngine.GameObject in_GameObjectID, AkChannelEmitterArray in_pPositions, ushort in_NumPositions, AK.SoundEngine.MultiPositionType in_eMultiPositionType) { return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetMultiplePositions__SWIG_2(AkSoundEngine.GetAkGameObjectID(in_GameObjectID), in_pPositions.m_Buffer, in_NumPositions, (int)in_eMultiPositionType); }
  ...
  public static AKRESULT PrepareBank(AK.SoundEngine.PreparationType in_PreparationType, string in_pszString, AkBankContent in_uFlags) { return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareBank__SWIG_0((int)in_PreparationType, in_pszString, (int)in_uFlags); }

  public static AKRESULT PrepareBank(AK.SoundEngine.PreparationType in_PreparationType, string in_pszString) { return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareBank__SWIG_1((int)in_PreparationType, in_pszString); }

  public static AKRESULT PrepareBank(AK.SoundEngine.PreparationType in_PreparationType, uint in_bankID, AkBankContent in_uFlags) { return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareBank__SWIG_2((int)in_PreparationType, in_bankID, (int)in_uFlags); }

  public static AKRESULT PrepareBank(AK.SoundEngine.PreparationType in_PreparationType, uint in_bankID) { return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareBank__SWIG_3((int)in_PreparationType, in_bankID); }

  public static AKRESULT PrepareBank(AK.SoundEngine.PreparationType in_PreparationType, string in_pszString, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie, AkBankContent in_uFlags) {
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
  ...
  public static AKRESULT PrepareBank(AK.SoundEngine.PreparationType in_PreparationType, string in_pszString, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie) {
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
  ...
  public static AKRESULT PrepareBank(AK.SoundEngine.PreparationType in_PreparationType, uint in_bankID, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie, AkBankContent in_uFlags) {
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
  ...
  public static AKRESULT PrepareBank(AK.SoundEngine.PreparationType in_PreparationType, uint in_bankID, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie) {
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
  ...
  public static AKRESULT PrepareEvent(AK.SoundEngine.PreparationType in_PreparationType, string [] in_ppszString, uint in_uNumEvent) {
  ...
  public static AKRESULT PrepareEvent(AK.SoundEngine.PreparationType in_PreparationType, uint[] in_pEventID, uint in_uNumEvent) { return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareEvent__SWIG_1((int)in_PreparationType, in_pEventID, in_uNumEvent); }

  public static AKRESULT PrepareEvent(AK.SoundEngine.PreparationType in_PreparationType, string [] in_ppszString, uint in_uNumEvent, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie) {
  ...
  public static AKRESULT PrepareEvent(AK.SoundEngine.PreparationType in_PreparationType, uint[] in_pEventID, uint in_uNumEvent, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie) {
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
  ...
  public static AKRESULT PrepareGameSyncs(AK.SoundEngine.PreparationType in_PreparationType, AkGroupType in_eGameSyncType, string in_pszGroupName, string [] in_ppszGameSyncName, uint in_uNumGameSyncs) {
  ...
  public static AKRESULT PrepareGameSyncs(AK.SoundEngine.PreparationType in_PreparationType, AkGroupType in_eGameSyncType, string in_pszGroupName, string [] in_ppszGameSyncName, uint in_uNumGameSyncs, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie) {
  ...
  public static AKRESULT PrepareGameSyncs(AK.SoundEngine.PreparationType in_PreparationType, AkGroupType in_eGameSyncType, uint in_GroupID, uint[] in_paGameSyncID, uint in_uNumGameSyncs, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie) {
		in_pCookie = new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
  ...
  public static AKRESULT PostCode(AK.Monitor.ErrorCode in_eError, AK.Monitor.ErrorLevel in_eErrorLevel, uint in_playingID, UnityEngine.GameObject in_gameObjID, uint in_audioNodeID, bool in_bIsBus) {
  ...
  public static AKRESULT PostCode(AK.Monitor.ErrorCode in_eError, AK.Monitor.ErrorLevel in_eErrorLevel, uint in_playingID, UnityEngine.GameObject in_gameObjID, uint in_audioNodeID) {
  ...
  public static AKRESULT PostCode(AK.Monitor.ErrorCode in_eError, AK.Monitor.ErrorLevel in_eErrorLevel, uint in_playingID, UnityEngine.GameObject in_gameObjID) {
  ...
  public static AKRESULT PostCode(AK.Monitor.ErrorCode in_eError, AK.Monitor.ErrorLevel in_eErrorLevel, uint in_playingID) { return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostCode__SWIG_3((int)in_eError, (int)in_eErrorLevel, in_playingID); }

  public static AKRESULT PostCode(AK.Monitor.ErrorCode in_eError, AK.Monitor.ErrorLevel in_eErrorLevel) { return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostCode__SWIG_4((int)in_eError, (int)in_eErrorLevel); }

  public static AKRESULT PostString(string in_pszError, AK.Monitor.ErrorLevel in_eErrorLevel, uint in_playingID, UnityEngine.GameObject in_gameObjID, uint in_audioNodeID, bool in_bIsBus) {
  ...
  public static AKRESULT PostString(string in_pszError, AK.Monitor.ErrorLevel in_eErrorLevel, uint in_playingID, UnityEngine.GameObject in_gameObjID, uint in_audioNodeID) {
  ...
  public static AKRESULT PostString(string in_pszError, AK.Monitor.ErrorLevel in_eErrorLevel, uint in_playingID, UnityEngine.GameObject in_gameObjID) {
  ...
  public static AKRESULT PostString(string in_pszError, AK.Monitor.ErrorLevel in_eErrorLevel, uint in_playingID) { return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostString__SWIG_3(in_pszError, (int)in_eErrorLevel, in_playingID); }

  public static AKRESULT PostString(string in_pszError, AK.Monitor.ErrorLevel in_eErrorLevel) { return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostString__SWIG_4(in_pszError, (int)in_eErrorLevel); }
  ...
  public static AKRESULT QueryIndirectPaths(UnityEngine.GameObject in_gameObjectID, PathsParams arg1, AkSoundPathInfoArray paths, uint numPaths) {

	var in_gameObjectID_id = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
	AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, in_gameObjectID_id);

    { return (AKRESULT)AkSoundEnginePINVOKE.CSharp_QueryIndirectPaths(in_gameObjectID_id, PathsParams.getCPtr(arg1), paths.GetBuffer(), numPaths); }
  }

  public static AKRESULT QuerySoundPropagationPaths(UnityEngine.GameObject in_gameObjectID, PathsParams arg1, AkPropagationPathInfoArray paths, uint numPaths) {

	var in_gameObjectID_id = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
	AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, in_gameObjectID_id);

    { return (AKRESULT)AkSoundEnginePINVOKE.CSharp_QuerySoundPropagationPaths(in_gameObjectID_id, PathsParams.getCPtr(arg1), paths.GetBuffer(), numPaths); }
  }
